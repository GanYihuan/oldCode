...
export default class Detail extends Component {
    ...
    return (
        <View style={styles.container}>
          ...
          <View style={styles.videoBox}>
            ...
            {/* Video is playing, control is paused */}
            {
              this.state.videoLoaded && this.state.playing
                  ?
                  <TouchableOpacity
          ...
          <Modal
              ...
              // The onRequestClose callback is called when
              // the user taps the hardware back button on Android
              // or the menu button on Apple TV
              onRequestClose={() => {
  ...
  _onProgress(data) {
    ...
    // toFixed(2): get Two digits after the decimal point
