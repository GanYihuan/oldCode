        ...
        <View style={styles.container}>
          ...
          <View style={styles.videoBox}>
            <Video
                ...
                volume={5}  // Sound: 0 is muted, 1 is double.
                paused={this.state.paused} // paused false or true
                rate={this.state.rate}  // 0 is paused, 1 is normal.
                muted={this.state.muted}  // Mutes true or false.
                resizeMode={this.state.resizeMode}  // Fill the whole screen at aspect ratio
                repeat={this.state.repeat}  // Repeat true or false.
                onLoadStart={this._onLoadStart.bind(this)} // Callback when video starts to load
                onLoad={this._onLoad.bind(this)} // Callback when video loading
            ...
            />
            {
              !this.state.videoOk && <Text style={styles.failText}>Video Error!</Text>
            }
          ...
          />
          <Modal
              animationType={'fade'}  //  modal animates.
